...
const HomePage = () => {
  ...
  // On retire le fireworks trigger simplifié pour éviter une erreur ; vous pourrez intégrer le vrai composant Fireworks plus tard.
      ...
      <div>
          ...
          <BackgroundVideo videoSrc={HERO_VIDEO}>
            <div className="max-w-4xl mx-auto px-4 text-center text-white py-20 md:py-32">
              ...
              >
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 bg-blush text-white px-8 py-4 rounded-full font-medium hover:bg-opacity-90 transition-all shadow-lg animate-pulse-slow"
                >
        ...
        <section ref={aboutRef} className="py-16 md:py-24 bg-cream dark:bg-anthracite">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <Link
              to="/agence"
              className="inline-flex items-center gap-2 border-2 border-blush text-blush hover:bg-blush hover:text-white px-6 py-3 rounded-full transition-all font-medium dark:border-gold dark:text-gold dark:hover:bg-gold dark:hover:text-anthracite"
            >
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                ...
                <motion.div
                  key={idx}
                  className="p-8 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-xl transition-shadow text-center"
                  initial={{ opacity: 0, y: 40 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
            ...
            <div className="relative bg-white dark:bg-gray-800 p-10 rounded-xl shadow-md">
              ...
              >
                <img
                  ...
                  className="w-20 h-20 rounded-full object-cover mb-4 border-2 border-blush"
                  loading="lazy"
                />
              ...
              <div className="flex justify-center mt-6 space-x-4">
                <button
                  ...
                  className="p-2 rounded-full border border-blush text-blush hover:bg-blush hover:text-white transition-colors"
        ...
        <section ref={contactRef} id="contact" className="py-16 md:py-24 bg-white dark:bg-gray-900">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-cream dark:bg-anthracite p-6 md:p-8 rounded-xl shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blush focus:border-transparent outline-none dark:bg-gray-700 dark:text-white"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select
                    name="styleRecherche"
                    id="styleRecherche"
                    value={formData.styleRecherche}
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blush focus:border-transparent outline-none"
                  >
              ...
              <button
                ...
                className="w-full md:w-auto px-8 py-4 bg-blush text-white font-medium rounded-full hover:bg-opacity-90 transition-all disabled:opacity-70"
              >
                {submitStatus === 'loading' ? 'Envoi...' : 'Envoyer ma demande'}
              </button>
              {submitStatus === 'success' && (
                <p className="text-green-500 mt-2">Message envoyé avec succès ! Nous revenons vers vous sous 48h.</p>
              )}
              {submitStatus === 'error' && (

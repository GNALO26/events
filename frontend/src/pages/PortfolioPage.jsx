...
const projects = [
  ...
  },
  {
    ...
    category: 'Château & Prestige',
    image: 'https://images.unsplash.com/photo-1507504031003-b417219a0fde?w=600',
  ...
  },
  {
    ...
    category: 'Bohème & Nature',
    image: 'https://images.unsplash.com/photo-1444210971048-6130cf0c46cf?w=600',
...
const PortfolioPage = () => {
  ...
  return (
    <div className="pt-8 pb-24">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full border transition-all ${
                activeCategory === cat
                  ...
                  : 'bg-transparent text-anthracite border-gray-300 hover:border-champagne hover:text-champagne'
              }`}
            >
              {cat}
            </button>
      ...
      {/* Modal avec lightbox navigation */}
      <Modal isOpen={selectedIndex !== null} onClose={closeModal}>
        {selectedProject && (
          <div className="relative aspect-video bg-black rounded-t-lg">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/40 text-white rounded-full p-2 backdrop-blur-sm transition-colors"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/40 text-white rounded-full p-2 backdrop-blur-sm transition-colors"
        ...
        {selectedProject && (
          <div className="p-6 bg-white rounded-b-lg">
            ...
            <p className="mt-4 italic text-gray-600">"Un moment suspendu hors du temps, merci à toute l'équipe."</p>
          </div>
        )}
      </Modal>
    </div>
